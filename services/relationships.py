...
def configure_relationships():
    ...
    StudentModel.self_descriptions = db.relationship('CategoryStudentSelfDescriptionModel', back_populates='student',
                                                     lazy='dynamic')
    CategoryModel.descriptions = db.relationship('CategoryStudentSelfDescriptionModel', back_populates='category',
                                                 lazy='dynamic')
    CategoryStudentSelfDescriptionModel.student = db.relationship('StudentModel', back_populates='self_descriptions')
    CategoryStudentSelfDescriptionModel.category = db.relationship('CategoryModel', back_populates='descriptions')
